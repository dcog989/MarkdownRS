...
This is a Markdown editor focused on performance, minimal resource usage, and a clean UI for technical and general users. We build for Linux first, with support for Windows.
...
- **SQLite** (v3.55) - Local database for metadata/bookmarks
