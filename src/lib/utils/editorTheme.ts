...
export function generateDynamicTheme(fontSize: number, fontFamily: string, isDark: boolean, insertMode: 'INS' | 'OVR') {
    ...
    return EditorView.theme({
        ...
        ".cm-highlightSpace": {
            ...
            position: "relative",
            "&:before": {
                content: "'·'", color: whitespaceColor, position: "absolute",
                top: "0", left: "0", pointerEvents: "none", fontWeight: "bold", transform: "scale(1.2)"
            }
        },
        ".cm-highlightTab": {
            backgroundImage: "none !important",
        ...
        ".cm-newline": {
            color: whitespaceColor, userSelect: "none", pointerEvents: "none",
            display: "inline-block", verticalAlign: "middle", marginLeft: "2px",
            fontWeight: "bold", transform: "scale(1.2)"
        },
    });
}
