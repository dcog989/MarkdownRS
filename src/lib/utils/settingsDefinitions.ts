  ...
  return [
    {
      ...
      type: 'select',
      category: 'settings.category.advanced',
      defaultValue: 'info',
...

    {
      ...
      type: 'file',
      category: 'settings.category.file',
      defaultValue: '',
    ...
    },
    {
      ...
      category: 'settings.category.editor',
      defaultValue: true,
      tooltip: 'settings.wordWrapTooltip',
    },
    {
      key: 'wrapGuideColumn',
    ...
    },
    {
      ...
      label: 'settings.autocomplete',
      type: 'boolean',
      category: 'settings.category.editor',
      defaultValue: true,
      tooltip: 'settings.autocompleteTooltip',
    },
    {
    ...
    },
    {
      ...
      category: 'settings.category.editor',
      defaultValue: false,
      tooltip: 'settings.autoSaveTooltip',
    },
    {
    ...
    },
    {
      ...
      type: 'boolean',
      category: 'settings.category.formatter',
      defaultValue: false,
    ...
    },
    {
      ...
      label: 'settings.bulletChar',
      type: 'select',
      category: 'settings.category.formatter',
      defaultValue: '-',
      options: ['-', '*', '+'],
      tooltip: 'settings.bulletCharTooltip',
    },
    {
      key: 'formatterEmphasisChar',
      label: 'settings.emphasisChar',
      type: 'select',
      category: 'settings.category.formatter',
      defaultValue: '*',
      options: ['*', '_'],
      optionLabels: ['*', '_'],
      tooltip: 'settings.emphasisCharTooltip',
    },
    {
      key: 'formatterCodeFence',
      label: 'settings.codeFenceStyle',
      type: 'select',
      category: 'settings.category.formatter',
      defaultValue: '```',
      options: ['```', '~~~'],
      tooltip: 'settings.codeFenceTooltip',
    },
    {
      key: 'tabWidthMin',
