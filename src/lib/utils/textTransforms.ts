...
/**
 * Performs text transformations on the provided content.
 * Optimized to avoid unnecessary string splitting for whole-text operations.
 */
export function transformText(text: string, operation: string): string {
    // Early return for whole-text operations (no line splitting needed)
    switch (operation) {
    ...
    // Line-based operations - split only when necessary
