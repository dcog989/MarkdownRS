...
<div class="relative w-full" bind:this={dropdownEl}>
    ...
    {#if isOpen}
        <div class="absolute z-50 w-full overflow-y-auto rounded border bg-bg-panel border-border-main shadow-lg {dropdownPosition === 'above' ? 'bottom-full mb-1' : 'top-full mt-1'}" style="max-height: 250px;">
