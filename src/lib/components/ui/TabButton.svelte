...
<div
    ...
    data-tab-id={tab.id}
    class="group text-ui-sm relative flex h-8 shrink-0 cursor-default items-start pt-2 pb-1.5 gap-2 text-left transition-colors duration-150 outline-none select-none"
