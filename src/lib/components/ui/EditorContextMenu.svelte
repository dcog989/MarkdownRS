<script lang="ts">
    ...
    import { BookPlus, BookText, ClipboardCopy, ClipboardPaste, Scissors, ArrowUpDown, ArrowDownUp, CaseSensitive, WrapText } from "lucide-svelte";
    ...
    function handleTransform(transformType: string) {
    ...
    >
        ...
        {#if hasSelection}
            ...
            <div class="relative">
                ...
                {#if showSortMenu}
                    <div 
                        class="absolute left-full top-0 ml-1 min-w-[180px] rounded-md shadow-xl border py-1 z-50"
            ...
            <div class="relative">
                ...
                {#if showTransformMenu}
                    <div 
                        class="absolute left-full top-0 ml-1 min-w-[200px] rounded-md shadow-xl border py-1 z-50"
                        style="background-color: var(--bg-panel); border-color: var(--border-light);"
                        onmouseenter={() => showTransformMenu = true}
                        onmouseleave={() => showTransformMenu = false}
                    >
