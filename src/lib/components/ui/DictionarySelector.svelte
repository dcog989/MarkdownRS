<script lang="ts">
    ...
    const availableDictionaries = [
        ...
        { code: 'da', name: 'Danish' },
        { code: 'nl', name: 'Dutch' },
        { code: 'en', name: 'English (US) -ize' },
        { code: 'en-AU', name: 'English (Australia) -ise' },
        { code: 'en-CA', name: 'English (Canada) -ise' },
        { code: 'en-GB', name: 'English (UK) -ise' },
        { code: 'en-ZA', name: 'English (South Africa) -ise' },
