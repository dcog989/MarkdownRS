...
<Modal bind:isOpen {onClose}>
    {#snippet header()}
        ...
        <div class="flex-1 relative mx-4">
            <Search
                size={12}
                class="absolute left-2.5 top-1/2 -translate-y-1/2 opacity-50 pointer-events-none"
            />
            <Input
            ...
            <div>
                {#each sortedSettings as setting, index}
                    <div
                        ...
                        !(setting as any).visibleWhen &&
                        !(setting as any).groupWith
                    ...
                    >
                        <div class="flex items-start justify-between gap-6">
                            ...
                            >
                                <span
                                    class="inline-block w-24 text-ui-sm opacity-60 shrink-0 mr-4 text-fg-muted"
                                >
                            ...
                            >
                                ...
                                {:else if setting.type === "range"}
                                    <div class="flex items-center gap-3">
                                        ...
                                        />
                                        <span
                                            class="text-ui-sm w-10 text-right font-mono opacity-80 text-fg-muted"
                                            >{getSettingValue(
                                                setting.key,
                                                setting.defaultValue
                                            )}%</span
