<script lang="ts">
    ...
    const settingsDefinitions = $derived([
        ...
        { key: "doubleClickSelectsTrailingSpace", label: "Double-Click Selects Trailing Space", type: "boolean", category: "Editor", defaultValue: false, tooltip: "When double-clicking a word, also select any trailing space" },
        ...
        { key: "recentChangesCount", label: "Recent Changes Number", type: "number", category: "Editor", defaultValue: 16, min: 0, max: 99, tooltip: "Max 99. Set to 0 to disable count-based filtering." },
        { key: "recentChangesTimespan", label: "Recent Changes Time Span (secs)", type: "number", category: "Editor", defaultValue: 600, min: 0, max: 9999, groupWith: "recentChangesCount", tooltip: "Max 9999. Set to 0 for unlimited time." },
        ...
        { key: "collapsePinnedTabs", label: "Collapse Pinned Tabs", type: "boolean", category: "Interface", defaultValue: false, tooltip: "Shrink pinned tabs to icon only" },
        ...
        { key: "tooltipDelay", label: "Tooltip Delay (ms)", type: "number", category: "Interface", defaultValue: 1250, min: 0, max: 5000 },
        { key: "findPanelTransparent", label: "Find Panel Transparent", type: "boolean", category: "Interface", defaultValue: false },
